...
class RAGService:
    def __init__(self, vector_store, llm_model, prompt_template_path="/Users/daniyalkhan/Documents/WORK-for-Compassion/projects/RAG-allama_audio/src/rag_service/prompt.txt"):
        self.retriever = vector_store.as_retriever(search_type="similarity", search_kwargs={"k": 10})
